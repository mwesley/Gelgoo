...
public class AutoTile : MonoBehaviour
{
    ...
    public void GetNeighbours()
    {
        ...
        i = 0; j = 1; try { target = Physics2D.OverlapCircle(new Vector2(x + i * size.x, y + j * size.y), 0.1f, autoTileLayer.value).gameObject; gates[0] = target != null; if (gates[0]) { newContacts.Add(target); };}
        catch { gates[0] = false; }
        i = 1; j = 0; try { target = Physics2D.OverlapCircle(new Vector2(x + i * size.x, y + j * size.y), 0.1f, autoTileLayer.value).gameObject; gates[1] = target != null; if (gates[1]) { newContacts.Add(target); };}
        catch { gates[1] = false; }
        i = 0; j = -1; try { target = Physics2D.OverlapCircle(new Vector2(x + i * size.x, y + j * size.y), 0.1f, autoTileLayer.value).gameObject; gates[2] = target != null; if (gates[2]) { newContacts.Add(target); };}
        catch { gates[2] = false; }
        i = -1; j = 0; try { target = Physics2D.OverlapCircle(new Vector2(x + i * size.x, y + j * size.y), 0.1f, autoTileLayer.value).gameObject; gates[3] = target != null; if (gates[3]) { newContacts.Add(target); };}
        catch { gates[3] = false; }
        i = -1; j = 1; try { target = Physics2D.OverlapCircle(new Vector2(x + i * size.x, y + j * size.y), 0.1f, autoTileLayer.value).gameObject; gates[4] = target != null; if (gates[4]) { newContacts.Add(target); };}
        catch { gates[4] = false; }
        i = 1; j = 1; try { target = Physics2D.OverlapCircle(new Vector2(x + i * size.x, y + j * size.y), 0.1f, autoTileLayer.value).gameObject; gates[5] = target != null; if (gates[5]) { newContacts.Add(target); };}
        catch { gates[5] = false; }
        i = 1; j = -1; try { target = Physics2D.OverlapCircle(new Vector2(x + i * size.x, y + j * size.y), 0.1f, autoTileLayer.value).gameObject; gates[6] = target != null; if (gates[6]) { newContacts.Add(target); };}
        catch { gates[6] = false; }
        i = -1; j = -1; try { target = Physics2D.OverlapCircle(new Vector2(x + i * size.x, y + j * size.y), 0.1f, autoTileLayer.value).gameObject; gates[7] = target != null; if (gates[7]) { newContacts.Add(target); };}
        catch { gates[7] = false; }
